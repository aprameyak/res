...
from app.schemas.resume import ResumeOut, ResumeListOut, BuilderUploadIn
from app.services.text_to_pdf import text_to_pdf_bytes
...
async def upload_from_builder(
    ...
    filename = payload.filename if payload.filename.endswith(".pdf") else f"{payload.filename}.pdf"
