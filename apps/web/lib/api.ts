...
export const resumesApi = {
  ...
  uploadFromBuilder: (content: string, filename = "resume.pdf") =>
    api
      .post<Resume>("/resumes/from-builder", { content, filename })
      .then((r) => r.data),
...
export const reportsApi = {
  download: async (evaluationId: string, candidateName: string) => {
    ...
    link.href = url;
    link.setAttribute("download", `resme_${candidateName.replace(/\s+/g, "_")}.pdf`);
